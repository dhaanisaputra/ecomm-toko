                            ...
                            <div class="w-full px-3 mb-6 sm:w-1/2 md:w-1/3" wire:key="{{ $item->id }}">
                                <div class="border border-gray-300 dark:border-gray-700">
                                    ...
                                    <div class="p-3 ">
                                        ...
                                        <p class="text-lg ">
                                            <span
                                                class="text-green-600 dark:text-green-600">{{ Number::currency($item->price, 'IDR', 'id') }}</span>
                                        </p>
                                    </div>
                                    <div class="flex justify-center p-4 border-t border-gray-300 dark:border-gray-700">

                                        <a wire:click.prevent='addToCart({{ $item->id }})' href="#"
                                            ...
                                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                                ...
                                                wire:target='addToCart({{ $item->id }})'>Add to Cart</span><span
                                                wire:loading
